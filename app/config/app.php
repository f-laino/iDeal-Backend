...
return [
    ...
    */
    'eurotax' => [
        'url' => env('EUROTAX_URL', ''),
        'username' => env('EUROTAX_USER', ''),
        'password' => env('EUROTAX_PWD', ''),
    ],

    'pipedrive' => [
        'url' => env('PIPEDRIVE_ENDPOINT', ''),
    ...
    | External services
    |--------------------------------------------------------------------------
    | You may protect incoming request from other services
    |
    */
    'request' => [
        'secret' => env('EXT_SECRET', ''),
        'quoter' => env('QUOTER_SECRET', '')
    ],
    ...
    */
    ...
    'providers' => [
        ...
        App\Providers\CdkServiceProvider::class,
