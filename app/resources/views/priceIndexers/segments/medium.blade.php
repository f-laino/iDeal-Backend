            ...
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            {!!  Form::text("1&25&24", $pattern['1&25&24'], ['class' => $errors->has('1&25&24') ? 'form-control is-invalid' : 'form-control']) !!}
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            {!!  Form::text("1&25&36", $pattern['1&25&36'], ['class' => $errors->has('1&25&36') ? 'form-control is-invalid' : 'form-control']) !!}
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            {!!  Form::text("0&25&24", $pattern['0&25&24'], ['class' => $errors->has('0&25&24') ? 'form-control is-invalid' : 'form-control']) !!}
                        </td>
                        <td>
                            <strong>24</strong> Mesi
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            {!!  Form::text("0&25&36", $pattern['0&25&36'], ['class' => $errors->has('0&25&36') ? 'form-control is-invalid' : 'form-control']) !!}
                        </td>
                        <td>
                            <strong>36</strong> Mesi
                        </td>
            ...
            <div class="col-md-12">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            {!!  Form::text("secondary_1&25&24", $secondaryPattern['1&25&24'], ['class' => $errors->has('secondary_1&25&24') ? 'form-control is-invalid' : 'form-control']) !!}
                        </td>
                        <td>
                            <strong>24</strong> Mesi
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            {!!  Form::text("secondary_1&25&36", $secondaryPattern['1&25&36'], ['class' => $errors->has('secondary_1&25&36') ? 'form-control is-invalid' : 'form-control']) !!}
                        </td>
                        <td>
                            <strong>36</strong> Mesi
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            {!!  Form::text("secondary_0&25&24", $secondaryPattern['0&25&24'], ['class' => $errors->has('secondary_0&25&24') ? 'form-control is-invalid' : 'form-control']) !!}
                        </td>
                        <td>
                            <strong>24</strong> Mesi
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            {!!  Form::text("secondary_0&25&36", $secondaryPattern['0&25&36'], ['class' => $errors->has('secondary_0&25&36') ? 'form-control is-invalid' : 'form-control']) !!}
                        </td>
                        <td>
                            <strong>36</strong> Mesi
                        </td>
